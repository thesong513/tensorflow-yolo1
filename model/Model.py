...
class Model():
	...
	def _build_model(self):
		...
		model.add(
			layers.Conv2D(filters=64, kernel_size=(7, 7), strides=(2, 2), padding="same",
						  kernel_initializer='random_uniform', use_bias=False, name="conv1"))
		...
		model.add(layers.Conv2D(filters=192, kernel_size=(3, 3), strides=(1, 1), padding="same",
		...
		model.add(layers.Conv2D(filters=128, kernel_size=(1, 1), strides=(1, 1), padding="same",
								kernel_initializer='random_uniform', use_bias=False,
								name="conv3"))
		...
		model.add(layers.Conv2D(filters=256, kernel_size=(1, 1), strides=(1, 1), padding="same",
								kernel_initializer='random_uniform', use_bias=False,
								name="conv5"))
		...
		model.add(layers.Conv2D(filters=512, kernel_size=(1, 1), strides=(1, 1), padding="same",
								kernel_initializer='random_uniform', use_bias=False,
								name="conv15"))
		model.add(layers.BatchNormalization(name="norm15"))
		model.add(layers.LeakyReLU(self.leaky_relu))
		
		model.add(layers.Conv2D(filters=1024, kernel_size=(3, 3), strides=(1, 1), padding="same",
								kernel_initializer='random_uniform', use_bias=False,
								name="conv16"))
		...
		# 4096
		model.add(layers.Dense(units=512, name="fc26", kernel_initializer='random_uniform',
							   bias_initializer='zeros'))
		model.add(layers.Dense(units=4096, name="fc27", kernel_initializer='random_uniform',
							   bias_initializer='zeros'))
	...
	def train(self, train_tfrecord, val_tfrecord, train_szie, val_size):
		...
		tensorboard = ks.callbacks.TensorBoard(log_dir='log', histogram_freq=0, write_graph=True, write_images=False)
